...
if data_type == tsi_str or data_type == seg_str or data_type == cat_str:
    deviation_threshold = 0.05  # original was 0.03, 'working:0.065', more setups '0.65', '0.045'
    fixed_threshold = 0.15  # original was 0.250, 'working:0.20', more setups '0.15', '0.20'
